...
bin-sed\sed.exe -i "s/FILL_32_LINK_PATH/%BOOST_LIB32_PATH%-msvc-11.0/g" BoostLibraryCheck-VC12.vcxproj
bin-sed\sed.exe -i "s/FILL_64_LINK_PATH/%BOOST_LIB64_PATH%-msvc-11.0/g" BoostLibraryCheck-VC12.vcxproj
